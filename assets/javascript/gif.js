...
$(document).ready(function(){
    var topics = ['Dog', 'Cat', 'Mouse', 'Bunny', 'Alpaca', 'Pig', 'Donkey', 'Horse', 'Monkey', 'Zebra', 'Lion', 'Penguin', 'Fish', 'Fox', 'Bird', 'Bear'];
...
//Adding a new animal and error if nothing added
